...
There are a few scenarios where you may have access to multiple
organizations such as if you are a contractor and have a Memfault account
for different companies you are working with or if you have a personal Memfault account in addition to the one for the company you work with.
