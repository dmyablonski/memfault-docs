...
There are two common scenarios where you may have access to multiple
organizations. Some large companies with subsidiaries that operate independently
may have different organizations. Some employees may wish to have visibility
into both Memfault accounts. If you are a contractor and have a memfault account
for different companies, you may have access to multiple organizations as well.
