...
organization will load. To set the organization loaded by default when navigating to https://app.memfault.com, click on the star icon next to that organization in the drop down.
